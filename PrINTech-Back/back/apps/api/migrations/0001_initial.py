    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colour', models.CharField(choices=[('RED', 'Red'), ('GREEN', 'Green'), ('YELLOW', 'Yellow'), ('BLUE', 'Blue'), ('MAGENTA', 'Magenta'), ('WHITE', 'White'), ('BLACK', 'Black'), ('PURPLE', 'Purple'), ('BROWN', 'Brown'), ('GREY', 'Grey'), ('ORANGE', 'Orange')], max_length=25)),
                ('type', models.CharField(choices=[('PLA', 'Pla'), ('REINFORCED_PLA', 'Reinforced Pla'), ('PETG', 'Petg'), ('ABS', 'Abs'), ('TPE/TPU', 'Tpe')], max_length=25)),
